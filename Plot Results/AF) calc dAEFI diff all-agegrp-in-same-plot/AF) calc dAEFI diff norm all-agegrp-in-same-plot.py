...
plot_title_text="Sum of the differences between age groups of normalized D-curves and doses, calculated for age groups from 15 to 85, including rolling and shift correlation" # Title of plot
annotation_text ="AF) calc dAEFI diff norm all-agegrp-in-same-plot.py / Curves without dAEFIS -vs- Curves with simulated dAEFIs / D-curves normalized per 100000 of Population deaths subtracted"
plotfile_name = "AF) calc dAEFI diff norm all-agegrp-in-same-plot" 
